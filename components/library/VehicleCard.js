    ...
    >
      ...
      <div className="card-body">
        <div className="d-flex align-items-center justify-content-between pb-1">
          {year && (
            <span className={`fs-sm${light ? " text-light" : ""} me-3`}>
              {year}
            </span>
          )}
          {dropdown ? (
            <Dropdown className="mt-n1 me-n2">
              <Dropdown.Toggle
                variant={`${
            ...
            checkbox && (
              <div className={`form-check${light ? " form-check-light" : ""}`}>
        ...
        {location && (
          <div className={`fs-sm${light ? " text-light opacity-70" : ""}`}>
                ...
                <div className="me-n1">
                  <div className="row g-2">
                    {footer.map((item, indx) => {
                      return (
                        <div key={indx} className="col me-sm-1">
                          <div
                            className={`${
                              light ? "bg-dark text-light" : "bg-secondary"
                            } rounded text-center w-100 h-100 text-nowrap p-2`}
                          >
                            <i
                              className={`${item[0]} ${
                                light ? "text-light" : "text-body"
                              } d-block h4 mb-0`}
                            ></i>
