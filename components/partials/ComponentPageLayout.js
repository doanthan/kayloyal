...
import ScrollLink from "../library/ScrollLink"
        ...
        <Row className="container-fixed-nav-start">
          <Col xl={9}>
            ...
            <Navbar
              as="header"
              bg="light"
              className="justify-content-end fixed-top shadow-sm px-3 px-xl-4"
            >
              <Navbar.Brand
                as={Link}
              ...
              <Navbar.Toggle
                className="d-block d-lg-none me-3 ms-auto border-0"
                onClick={handleShow}
              />
            ...
            <aside className="fixed-nav-start bg-dark">
              <div className="d-flex align-items-center p-4">
                <Navbar.Brand as={Link} href="/test/components/typography">
                  <Image
                    priority
              ...
              <SimpleBar className="fixed-nav-body simplebar-light pt-2 pb-4">
                ...
                >
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/icon-font"
                    className="fs-sm"
                  >
                    Icon font
                  </Nav.Link>
                ...
                <h6 className="fs-base text-light mx-n4 mb-1 pt-4 pb-2 px-4">
                  Components
                </h6>
                <Nav
                  as="nav"
                ...
                >
                  <Nav.Link
                    as={Link}
                    href="/test/components/accordion"
                    className="fs-sm"
                  >
                    Accordion
                  </Nav.Link>
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/breadcrumb"
                    className="fs-sm"
                  >
                    Breadcrumb
                  </Nav.Link>
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/button-group"
                    className="fs-sm"
                  >
                    Button group
                  </Nav.Link>
                  <Nav.Link
                    as={Link}
                    href="/test/components/cards-basic"
                    className="fs-sm"
                  >
                    Cards: Basic
                  </Nav.Link>
                  <Nav.Link
                    as={Link}
                    href="/test/components/cards-advanced"
                    className="fs-sm"
                  >
                    Cards: Advanced
                  </Nav.Link>
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/date-picker"
                    className="fs-sm"
                  >
                    Date / time picker
                  </Nav.Link>
                  <Nav.Link
                    as={Link}
                    href="/test/components/dropdowns"
                    className="fs-sm"
                  >
                    Dropdowns
                  </Nav.Link>
                  <Nav.Link
                    as={Link}
                    href="/test/components/file-uploader"
                    className="fs-sm"
                  >
                    File uploader
                  </Nav.Link>
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/form-group"
                    className="fs-sm"
                  >
                    Form group
                  </Nav.Link>
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/input-group"
                    className="fs-sm"
                  >
                    Input group
                  </Nav.Link>
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/list-group"
                    className="fs-sm"
                  >
                    List group
                  </Nav.Link>
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/offcanvas"
                    className="fs-sm"
                  >
                    Offcanvas
                  </Nav.Link>
                  <Nav.Link
                    as={Link}
                    href="/test/components/pagination"
                    className="fs-sm"
                  >
                    Pagination
                  </Nav.Link>
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/placeholders"
                    className="fs-sm"
                  >
                    Placeholders
                  </Nav.Link>
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/social-buttons"
                    className="fs-sm"
                  >
                    Social buttons
                  </Nav.Link>
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/testimonials"
                    className="fs-sm"
                  >
                ...
                >
                  ...
                  <Nav.Link
                    href="https://react-bootstrap.github.io/utilities/transitions/"
                    className="fs-sm"
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  <Nav.Link
                    as={Link}
                    href="/test/components/utilities"
                    className="fs-sm"
                  >
                    Finder
                  </Nav.Link>
                  ...
                  <div className="ps-4 border-start">
                    ...
                    {props.anchorLinks.map((link, index) => (
                      <ScrollLink
                        ...
                        duration={600}
                        offset={-110}
                        className="nav-link scroll-link py-1 px-0 fs-sm fw-normal"
                        key={index}
                      >
                        {link.label}
                      </ScrollLink>
