...
import PasswordToggle from "../library/PasswordToggle"
...
const SignInModalDark = ({ onSwap, pillButtons, ...props }) => {
  ...
  return (
    <Modal
      ...
      contentClassName="bg-info border-light"
    >
      <Modal.Body className="px-0 py-2 py-sm-0">
        ...
        <div className="row mx-0 align-items-center">
          ...
          <div className="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
            <Button
              variant={`outline-info ${pillButtons ? "rounded-pill" : ""
                } w-100 mb-3`}
            >
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              ...
              <Form.Group className="mb-4">
                <div className="d-flex align-items-center justify-content-between mb-2">
                  <Form.Label htmlFor="si-password" className="text-light mb-0">
                    Password
                  </Form.Label>
