...
import EditMultipleTemplates from '../components/khub/TemplateEditor/ModalEditMultipleTemplates';
import EditAllTemplates from '../components/khub/TemplateEditor/EditAllTemplates';
    ...
    return (
        <Container fluid className="vh-100 py-4 email-editor-container">
                ...
                <Col md={4} className="d-flex flex-column">
                    <div className="mb-3 text-center">
                        ...
                        <div className="d-flex gap-2 mb-3">
                            <Button onClick={() => setShowEditAllModal(true)}>
                                Edit All
                            </Button>
                        </div>
                    </div>
            ...
            <EditAllTemplates
                ...
                mergeFieldStates={mergeFieldStates}
                onSave={(updatedMergeFieldStates) => {
                    setMergeFieldStates(updatedMergeFieldStates);

                    // Update current template's fields if it was changed
                    if (selectedTemplate && updatedMergeFieldStates[selectedTemplate.value]) {
                        setMergeFields(updatedMergeFieldStates[selectedTemplate.value]);
                    }
                }}
            />
            <EditMultipleTemplates
                show={showMultiEditModal}
                onHide={() => setShowMultiEditModal(false)}
                mergeFields={mergeFields}
                selectedTemplate={selectedTemplate}
                parseMergeFields={parseMergeFields}
                onSave={(newMergeFields) => {
                    setMergeFields(newMergeFields);
                    setMergeFieldStates(prev => ({
                        ...prev,
                        [selectedTemplate.value]: newMergeFields
                    }));
                }}
            />
