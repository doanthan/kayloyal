...
const BlogSinglePage = ({ user }) => {
  ...
  const postImage = "/images/car-finder/blog/01.jpg"
            ...
            <div className="pt-4 pb-5 mb-md-3">
              <div className="d-md-flex align-items-center justify-content-between border-top pt-4">
                <div className="d-flex align-items-center me-3 mb-3 mb-md-0">
                  <span className="d-none d-sm-block fw-bold text-nowrap mb-2 me-2 pe-1">
                    Tags:
                  </span>
                  <div className="d-flex flex-wrap">
                    <Button
                      ...
                      href="#"
                      size="xs"
                      variant="rounded-pill fs-sm fw-normal me-2 mb-2"
                    >
                      Reviews
                    </Button>
                    <Button
                    ...
                    <Button
                      ...
                      href="#"
                      size="xs"
                      variant="rounded-pill fs-sm fw-normal mb-2"
                    >
                      Harley Davidson
                    </Button>
                  </div>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="d-flex">
                    ...
                    >
                      <Button
                        size="xs"
                        variant="icon btn-rounded-circle shadow-sm mb-2 ms-2"
                      >
