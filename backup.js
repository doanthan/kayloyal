...
const extractFields = (data) => {
    ...
    const { TIME = defaultValues.TIME, PUBLIC = defaultValues.PUBLIC, UID = defaultValues.UID, VAPID_PUBLIC = defaultValues.VAPID_PUBLIC, TIMING_TYPE = defaultValues.TIMING_TYPE, PAGE_SECONDS = defaultValues.PAGE_SECONDS } = data;
    return { TIME, PUBLIC, UID, VAPID_PUBLIC, TIMING_TYPE, PAGE_SECONDS };
};

const main = async () => {
    const accountData = await fetchAccountData();
    const { TIME, PUBLIC, UID, VAPID_PUBLIC, TIMING_TYPE, PAGE_SECONDS } = extractFields(accountData);
